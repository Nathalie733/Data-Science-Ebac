...
st.set_page_config(
     ...
     page_icon="https://www.google.com/url?sa=i&url=https%3A%2F%2Faspaen.edu.co%2Fyatay%2Faspaen-yatay%2F%3Fw%3Dmoney-bag-with-pile-coins-and-bills-cash-on-ee-GvxLqUo&psig=AOvVaw30kykrsTRgCmZ_GL_er8oM&ust=1715115114991000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCNjuh-7z-YUDFQAAAAAdAAAAABAR",
     layout="wide",
)

st.write('# Análise da previsão de renda')
